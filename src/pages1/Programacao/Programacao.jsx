  ...
  return (
    <div className={S.contProg} id='Programer'>
      ...
      <div className={S.bloco2}>
        <h4 className={S.sobreP}>Confesso que no começo foi bem sofrido, era muito difícil assimilar as coisas, mas com o tempo eu fui desenvolvendo gosto pela área e hoje busco minha primeira oportunidade de emprego! Ainda estou engatinhando, pois tenho dificuldade em backend, mas tenho buscado melhorar!</h4>
      </div>
      </div>
